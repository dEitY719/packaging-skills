...
| Skill | Read | Use when |
|-------|------|----------|
| `scaffold-repo` | `@./skills/scaffold-repo/SKILL.md` | Scaffolding a brand-new marketplace repo — structure, manifests, skill import, `git init`, repo create, push. New repos only. |
...
- `scaffold-repo` and `rename-repo` both reach `gh repo create` / `git push`. Confirm
